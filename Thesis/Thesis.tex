...
In this thesis we propose two novel heuristics, working upon the same assumptions, to build higher-quality BVHs, a data structure to make it possible to use them, and a comparative analysis of their performance in different scenarios.
