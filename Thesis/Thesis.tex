...
\begin{figure}[]
    \centering
    \includegraphics[width=\textwidth*\real{0.4}]{Images/direction_affinity.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth*\real{0.6}]{Images/double_area.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth*\real{0.6}]{Images/outside_area.png}
...
\begin{figure}[H]
	...
	\subfloat[$x$ axis plane]{
    	\includegraphics[scale=0.15]{Images/x_axis_plane.png}
	}
	\qquad
	\subfloat[$y$ axis plane]{
    	\includegraphics[scale=0.15]{Images/y_axis_plane.png}
	}
	\qquad
	\subfloat[$z$ axis plane]{
    	\includegraphics[scale=0.15]{Images/z_axis_plane.png}
	}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth*\real{0.6}]{Images/three_parallelograms.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth*\real{0.35}]{Images/right_plane.png}
