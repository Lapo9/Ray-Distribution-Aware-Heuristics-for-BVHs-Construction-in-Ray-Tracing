...
The first novel contribution of this works is based exactly on this simple observation, and on the refutation of the last hypothesis of surface area heuristic. In the next sections we will describe two relevant ray distributions that organically forms in the scenes, due to the use of direct light importance sampling.
