...
Moreover, it is also unbiased, therefore the value it converges to is the value of the definite integral of the function it is estimating. The rate of convergence is proportional to the variance $\sigma^2$, this means that, in order to reduce the estimator error by half, 4 times more samples are needed.
