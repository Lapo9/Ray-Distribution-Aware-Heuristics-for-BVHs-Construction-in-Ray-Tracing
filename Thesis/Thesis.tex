...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth*\real{0.5}]{Images/ortho_projection.png}
...
\begin{figure}[]
    \centering
    \includegraphics[width=\textwidth*\real{0.7}]{Images/multiple_influence_areas.png}
...
\begin{figure}[H]
	...
	\subfloat[Plane influence area]{
    	\includegraphics[width=\textwidth*\real{0.45}]{Images/obb_3d.png}
	}
	\qquad
	\subfloat[Point influence area]{
    	\includegraphics[width=\textwidth*\real{0.45}]{Images/frustum_3d.png}
	}
